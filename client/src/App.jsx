...
//   // Admin routes
//   else if (path === '/admin/productlist') {
//     content = userInfo && userInfo.isAdmin ? <ProductListPage navigate={navigate} /> : <LoginPage navigate={navigate} />;
//   }
...
//   }
//   else if (path.startsWith('/admin/user/') && path.endsWith('/edit')) {
...
//       <main className="flex-grow container mx-auto px-4 py-8">{content}</main>
//       <Footer />
//     </div>
//   );
// }
...
// FILE: client/src/App.jsx (Updated with Category Routes)
// FILE: client/src/App.jsx (Final Corrected and Complete Version)
...
// Admin Pages (assuming they are in a subfolder)
...
export default function App() {
  ...
  return (
    <div className="bg-slate-50 min-h-screen flex flex-col font-sans">
      ...
      <Header navigate={navigate} />
      {/* --- THIS IS THE FIX --- */}
      {/* The responsive container and padding classes have been restored to the main element. */}
      {/* This ensures a consistent, professional layout across all pages. */}
